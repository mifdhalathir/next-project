...
export default function FABMenu() {
  ...
  return (
    <div className="fixed bottom-24 left-1/2 -translate-x-[120%] z-[51] flex flex-col items-center gap-4">
      {/* Pop-up Menu */}
      <div
        className={`bg-white/90 dark:bg-wood-800/90  p-4 rounded-2xl shadow-2xl border border-white/20 w-56 transform origin-bottom transition-all duration-500 ease-out ${
