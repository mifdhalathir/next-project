...
export default function FABMenu() {
  ...
  return (
    <div className="fixed bottom-6 right-24 z-[51] flex flex-col items-end gap-4">
      {/* Pop-up Menu */}
      <div
        className={`bg-white/90 dark:bg-wood-800/90  p-4 rounded-2xl shadow-2xl border border-white/20 w-56 transform origin-bottom-right transition-all duration-500 ease-out ${
